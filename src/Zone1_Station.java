...
public class Zone1_Station {
    ...
    public static void main(String[] args) {
        String stations[][] = {{"Metropoliton", "Aldgate", "Liverpool St", "Moorgate", "Kings Cross", "Euston"},
                ...
                {"Victoria", "Kings Cross", "Euston", "Warren Steer", "Oxford Circus", "Green PArk" }};
        String lines=""; //variable to list all the lines passing through the destination
        Scanner scan=new Scanner(System.in);
        System.out.println("Enter the station name from the given name: Aldgate,Kings Cross,Moorgate,Euston,Old Street,Liverpool St,Angle,Oxford Circus,Green Park," +
                "Waren Street, Bank,");
